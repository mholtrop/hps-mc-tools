...
//  const double pi=3.141592653589793;
    ...
    options
            .add_options()
                    ...
                    ("xmin",  "Set minimum x at 150cm (Ecal).", cxxopts::value<double>()->default_value("-100."))
                    ("xmax",  "Set maximum x at 150cm (Ecal).", cxxopts::value<double>()->default_value("100."))
                    ("ymin",  "Set minimum y at 150cm (Ecal).", cxxopts::value<double>()->default_value("0.2"))
